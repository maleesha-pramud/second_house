                                ...
                                <div className="flex gap-2 overflow-x-auto pb-2">
                                    {room.images.map((image, index) => (
                                        <button
                                            ...
                                            className={`flex-shrink-0 rounded-xl overflow-hidden transition-all duration-300 ${selectedImage === index ? "ring-3 ring-warm-400 shadow-lg" : "hover:ring-2 hover:ring-warm-300"
                                                }`}
                                        >
                                            <Image
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    {Object.entries(room.amenities).map(([key, value]) => (
                                        <div
                                            key={key}
                                            className={`flex items-center gap-3 p-4 rounded-xl border-2 transition-all duration-300 ${value
